...
export const POST: RequestHandler = async ({ request }) => {
    ...
    const benchmark = {
        ...
        baselineMs,
        meetsContainmentBaseline: typeof containmentLatencyMs === 'number' ? containmentLatencyMs <= baselineMs : false,
        soarAutomationSpeed: typeof containmentLatencyMs === 'number' ? Math.max(0, baselineMs - containmentLatencyMs) : 0
    };
